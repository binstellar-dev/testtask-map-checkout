...
class Edit extends \Magento\Backend\App\Action
{
     ...
     * @param \CustomMapDisplay\ClickAndCollect\StoreRepositoryInterface $storeRepository
     */
    ...
    public function execute()
    {
        ...
        $resultPage->setActiveMenu('CustomMapDisplay_ClickAndCollect::manage_stores');
